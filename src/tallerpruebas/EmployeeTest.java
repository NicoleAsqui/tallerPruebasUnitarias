...
class EmployeeTest {
	 ...
	 * if the month is odd.
	 */
	// Test en caso que Employee tenga un salario de salario de 400F con una moneda en Euros, un porcentaje de bonificacion del 80% y sea un trabajador
	@Test
	void testCs1() {
	...
	// Test en caso que Employee tenga un salario de salario de 400F con una moneda en Euros, un porcentaje de bonificacion del 80% y sea un Supervisor
	@Test
	void testCs2() {
	...
	// Test en caso que Employee tenga un salario de salario de 400F con una moneda en Euros, un porcentaje de bonificacion del 80% y sea un Manager
	@Test
	void testCs3() {
	...
	// Test en caso que Employee tenga un salario de salario de 400F con una moneda en Dolares, un porcentaje de bonificacion del 80% y sea un trabajador
	@Test
	void testCs4() {
	...
	// Test en caso que Employee tenga un salario de salario de 400F con una moneda en Dolares, un porcentaje de bonificacion del 80% y sea un Supervisor
	@Test
	void testCs5() {
	...
	// Test en caso que Employee tenga un salario de salario de 400F con una moneda en Dolares, un porcentaje de bonificacion del 80% y sea un Manager
	@Test
	void testCs6() {
	...
	void testCalculateYearBonusWorkerUSD() {
		...
		Employee emp =	new Employee(salary,currency,bonusPercentage,etype);
		float expected =386;
